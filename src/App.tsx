...
class App extends React.Component<{}, IState> {
  ...
  public async componentDidMount() {
    this.checkForNewAwardsRequest();
    setInterval(this.processResponse, 3 * 1000);
  }

  public async checkForNewAwardsRequest() {
    return request('https://polakpotrafi.pl/projekt/auto-stop-race-2019/', this.processResponse);
  }
